...
public class ModelPredicateRegistryImpl {
    ...
    private static final Map<Identifier,Serializer<? extends ModelPredicate>> IDENTIFIER_TO_SERIALIZER = new HashMap<>();
    private static final Map<Serializer<? extends ModelPredicate>,Identifier> SERIALIZER_TO_IDENTIFIER = new HashMap<>();
    private static boolean finalized = false;

    public static synchronized void registerPredicate(Identifier identifier, Serializer<? extends ModelPredicate> serializer){
        if(finalized)
