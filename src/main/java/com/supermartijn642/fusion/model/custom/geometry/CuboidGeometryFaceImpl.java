...
public class CuboidGeometryFaceImpl implements CuboidModelGeometry.Face {
    ...
    public static CuboidModelGeometry.Face of(BlockElementFace face){
        return builder()
            ...
            .property(ModelProperty.FORGE_GEOMETRY_COLOR, face.data().color())
            .property(ModelProperty.FORGE_GEOMETRY_BLOCK_LIGHT, face.data().blockLight())
            .property(ModelProperty.FORGE_GEOMETRY_SKY_LIGHT, face.data().skyLight())
            .property(ModelProperty.FORGE_GEOMETRY_AMBIENT_OCCLUSION, face.data().ambientOcclusion())
            .build();
    }
    ...
    public CuboidGeometryFaceImpl(String material, BlockElementFace.UVs uv, Quadrant rotation, Direction cullDirection, Integer tintIndex, Boolean shade, Integer lightEmission, Boolean ambientOcclusion, Boolean emissive, Map<ModelProperty<?,?>,Function<?,?>> properties){
