...
public class SpriteImageSourceImpl implements SpriteImageSource {
    ...
    public static SpriteImageSource vanilla(BufferedImage image, AnimationMetadataSection vanillaMetadata) throws UserErrorException{
        int defaultSize = Math.min(image.getWidth(), image.getHeight());
        return vanilla(image, vanillaMetadata, defaultSize, defaultSize);
    }

    public static SpriteImageSource vanilla(BufferedImage image, AnimationMetadataSection vanillaMetadata, int defaultFrameWidth, int defaultFrameHeight) throws UserErrorException{
        ...
        for(net.minecraft.client.resources.data.AnimationFrame frame : vanillaMetadata.animationFrames){
            frames.add(AnimationFrame.of(
                ...
                frame.getFrameIndex() / frameColumns * frameHeight,
