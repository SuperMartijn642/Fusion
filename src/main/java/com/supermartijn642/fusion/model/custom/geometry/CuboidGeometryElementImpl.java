...
public class CuboidGeometryElementImpl implements CuboidModelGeometry.Element {
    ...
    private CuboidGeometryElementImpl(Vector3f from, Vector3f to, BlockPartRotation rotation, Map<EnumFacing,CuboidModelGeometry.Face> faces, Boolean shade, Integer lightEmission, Boolean emissive, Map<Property<?,?>,Function<?,?>> properties){
        this.from = from;
        this.to = to;
