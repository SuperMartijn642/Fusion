...
public class ModelQuadData {
    ...
    private ModelQuadData(QuadView quad){
        ...
        for(int i = 0; i < 4; i++){
            ...
            this.vertexColor[i] = quad.color(i);
            this.vertexUV[i][0] = quad.u(i);
            this.vertexUV[i][1] = quad.v(i);
    ...
    public void emit(QuadEmitter emitter){
        ...
        for(int i = 0; i < 4; i++){
            ...
            emitter.color(i, this.vertexColor[i]);
            emitter.uv(i, this.vertexUV[i][0], this.vertexUV[i][1]);
