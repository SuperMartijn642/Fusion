...
public abstract class CombinedBakedModel implements BakedModel {
    ...
    public boolean useAmbientOcclusion(BlockState state){
        return this.getModels().getFirst().useAmbientOcclusion(state);
    }

    @Override
    public boolean useAmbientOcclusion(BlockState state, RenderType renderType){
        return this.getModels().getFirst().useAmbientOcclusion(state, renderType);
    }
    ...
    public List<RenderType> getRenderTypes(ItemStack itemStack, boolean fabulous){
        return this.getModels().getFirst().getRenderTypes(itemStack, fabulous);
    }

    @Override
    public List<BakedModel> getRenderPasses(ItemStack itemStack, boolean fabulous){
        return this.getModels().getFirst().getRenderPasses(itemStack, fabulous);
    }
}
