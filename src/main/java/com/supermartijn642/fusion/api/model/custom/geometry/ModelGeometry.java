...
public interface ModelGeometry {
    ...
    /**
     * Converts the given {@link IModel} to a {@link ModelGeometry} instance.
     */
    static ModelGeometry of(IModel model){
     ...
     * @see CuboidModelGeometry
     */
    static CuboidModelGeometry of(ModelBlock cuboidModel){
    ...
    interface QuadConsumer {
         ...
         */
        void consume(MutableQuad quad, EnumFacing cullDirection, PropertyGetter geometryProperties);
    }
