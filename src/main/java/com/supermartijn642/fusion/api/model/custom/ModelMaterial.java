...
public interface ModelMaterial {
    ...
    /**
     * Converts the given {@link RenderMaterial} to a {@link ModelMaterial} instance.
     */
    static ModelMaterial of(RenderMaterial material){
     ...
     */
    default RenderMaterial toRenderMaterial(){
        return new RenderMaterial(this.atlas(), this.texture());
    }
