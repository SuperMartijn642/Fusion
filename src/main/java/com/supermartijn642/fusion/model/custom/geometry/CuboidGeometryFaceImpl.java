...
public class CuboidGeometryFaceImpl implements CuboidModelGeometry.Face {
    ...
    public static CuboidModelGeometry.Face of(BlockPartFace face){
        return builder()
            .material(face.texture)
            .uv(face.blockFaceUV.uvs == null ? null : new UV(face.blockFaceUV.uvs[0], face.blockFaceUV.uvs[1], face.blockFaceUV.uvs[2], face.blockFaceUV.uvs[3]))
            .rotation(Rotation.byAngle(face.blockFaceUV.rotation))
            .cullDirection(face.cullFace)
    ...
    public CuboidGeometryFaceImpl(String material, UV uv, Rotation rotation, EnumFacing cullDirection, Integer tintIndex, Boolean shade, Integer lightEmission, Boolean emissive, Map<ModelProperty<?,?>,Function<?,?>> properties){
    ...
    private static class Builder implements CuboidModelGeometry.Face.Builder {
        ...
        private EnumFacing cullDirection;
        ...
        @Override
        public Builder cullDirection(EnumFacing direction){
