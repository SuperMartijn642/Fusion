...
public interface CuboidModelDataBuilder<T extends CuboidModelDataBuilder<T,S>, S> {
     ...
     */
    static CuboidModelDataBuilder<?,CuboidModel> builder(){
     ...
     */
    T parent(@Nullable Identifier parent);
     ...
     */
    default T material(String key, ModelMaterial material){
     ...
     */
    default T material(String key, Identifier texture, boolean forceTranslucent){
     ...
     */
    T guiLight(@Nullable UnbakedModel.GuiLight guiLight);
