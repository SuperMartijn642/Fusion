    ...
    public static void reload(ResourceManager resourceManager){
        ...
        for(ResourceLocation fullLocation : resourceManager.listResources(LOCATION, s -> s.endsWith(".json"))){
            ...
            try{
                ...
                FusionClient.LOGGER.error("Failed to parse json from entity model modifier '{}'!", fullLocation, e);
            }catch(Exception e){
                FusionClient.LOGGER.error("Encountered an exception whilst reading entity model modifier at '{}'!", fullLocation, e);
            }
        }
