...
public class ModelBakeryMixin {
    ...
    private CompletableFuture<ModelBakery.BakingResult> applyBlockModelOverlays(CompletableFuture<ModelBakery.BakingResult> future, MaterialBaker materialBaker, Executor executor){
        ...
        return future.thenApply((results) -> {
            ...
            ModelBakery.ModelBakerImpl resolver = ((ModelBakery)(Object)this).new ModelBakerImpl(materialBaker, new ModelBakery.InternerImpl(), results.missingModels());
