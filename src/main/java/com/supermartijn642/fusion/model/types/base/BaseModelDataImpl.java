...
public class BaseModelDataImpl implements BaseModelData {
    ...
    public BaseModelDataImpl(ResourceLocation parent, Map<String,Either<String,ModelMaterial>> materials, Boolean ambientOcclusion, Boolean shade, Boolean emissive, BlockModel.GuiLight guiLight, CuboidModelGeometry geometry, Map<ItemDisplayContext,ItemTransform> itemTransforms, List<ItemOverride> itemOverrides, RenderTypeGroup forgeRenderTypeGroup){
        this.parent = parent;
