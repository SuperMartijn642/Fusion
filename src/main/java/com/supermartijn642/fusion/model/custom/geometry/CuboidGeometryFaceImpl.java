...
public class CuboidGeometryFaceImpl implements CuboidModelGeometry.Face {
    ...
    public static CuboidModelGeometry.Face of(BlockElementFace face){
        return builder()
            ...
            .property(ModelProperty.NEO_GEOMETRY_COLOR, face.faceData().color())
            .property(ModelProperty.NEO_GEOMETRY_BLOCK_LIGHT, face.faceData().blockLight())
            .property(ModelProperty.NEO_GEOMETRY_SKY_LIGHT, face.faceData().skyLight())
            .property(ModelProperty.NEO_GEOMETRY_AMBIENT_OCCLUSION, face.faceData().ambientOcclusion())
            .build();
    }
