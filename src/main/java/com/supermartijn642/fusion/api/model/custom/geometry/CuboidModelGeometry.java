...
public interface CuboidModelGeometry extends ModelGeometry {
     ...
     */
    static CuboidModelGeometry of(UnbakedCuboidGeometry geometry){
    ...
    interface Element extends PropertyGetter {
        ...
        /**
         * Converts the given {@link CuboidModelElement} to an {@link Element}.
         */
        static Element of(CuboidModelElement element){
        ...
        interface Builder {
             ...
             */
            Builder rotation(@Nullable CuboidRotation rotation);
    ...
    interface Face extends PropertyGetter {
        ...
        /**
         * Converts the given {@link CuboidFace} to a {@link Face}.
         */
        static Face of(CuboidFace face){
        ...
        interface Builder {
             ...
             */
            Builder uv(@Nullable CuboidFace.UVs uv);
            ...
            default Builder uv(float minU, float minV, float maxU, float maxV){
                return this.uv(new CuboidFace.UVs(minU, minV, maxU, maxV));
            }
