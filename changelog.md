...
- Fixed default block render type not being included in model render types
...
- Fixed crash for composite models with a model series without a default
...
- Fixed interpolation of animated textures always showing the first frame
