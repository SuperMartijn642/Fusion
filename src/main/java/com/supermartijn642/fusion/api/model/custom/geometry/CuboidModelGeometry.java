...
public interface CuboidModelGeometry extends ModelGeometry {
     ...
     * @param materialResolver resolver for material keys
     */
    static QuadAccess bakeFace(Face face, Element element, EnumFacing side, ModelTransform transformation, MaterialResolver materialResolver){
     ...
     * @param materialResolver resolver for material keys
     */
    static void bakeFace(QuadConsumer consumer, Face face, Element element, EnumFacing side, ModelTransform transformation, MaterialResolver materialResolver){
