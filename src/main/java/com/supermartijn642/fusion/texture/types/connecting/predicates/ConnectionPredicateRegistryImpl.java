 ...
 */
public class ConnectionPredicateRegistryImpl {
    ...
    public static synchronized void registerPredicate(Identifier identifier, Serializer<? extends ConnectionPredicate> serializer){
        if(finalized)
