...
public class CuboidGeometryElementImpl implements CuboidModelGeometry.Element {
    ...
    private CuboidGeometryElementImpl(Vector3f from, Vector3f to, BlockPartRotation rotation, Map<Direction,CuboidModelGeometry.Face> faces, Boolean shade, Integer lightEmission, Boolean emissive, Map<ModelProperty<?,?>,Function<?,?>> properties){
        this.from = from;
        this.to = to;
