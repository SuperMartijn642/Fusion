...
public class BlockStateWrapperModelPredicate implements ModelPredicate {
    ...
    public static final Serializer<BlockStateWrapperModelPredicate> SERIALIZER = new Serializer<>() {
        @Override
    ...
    public final boolean equals(Object o){
        ...
        if(!(o instanceof BlockStateWrapperModelPredicate that)) return false;
