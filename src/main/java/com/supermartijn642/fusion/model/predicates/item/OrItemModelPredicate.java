...
public class OrItemModelPredicate implements ItemModelPredicate {
    ...
    public static final Serializer<OrItemModelPredicate> SERIALIZER = new Serializer<OrItemModelPredicate>() {
        @Override
    ...
    public final boolean equals(Object o){
        ...
        if(!(o instanceof OrItemModelPredicate)) return false;

        OrItemModelPredicate that = (OrItemModelPredicate)o;
