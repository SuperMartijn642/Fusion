...
public class MinimumVersionWarningScreen extends Screen {
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks){
        ...
        GuiComponent.hLine(poseStack, -115, 115, 44, FastColor.ARGB32.color(255, 255, 255, 255));
        ...
        GuiComponent.hLine(poseStack, -115, 115, 66 + textHeight, FastColor.ARGB32.color(255, 255, 255, 255));
