 ...
 */
public abstract class FusionBlockModelModifierProvider implements IDataProvider {
    ...
    public final void run(DirectoryCache cache) throws IOException{
        ...
        for(Map.Entry<ResourceLocation,ModifierBuilder> entry : this.modifiers.entrySet()){
            ...
            Path path = Paths.get("assets", location.getNamespace(), "fusion/model_modifiers/blocks", location.getPath() + extension);
