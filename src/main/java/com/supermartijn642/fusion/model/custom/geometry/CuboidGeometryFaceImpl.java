...
public class CuboidGeometryFaceImpl implements CuboidModelGeometry.Face {
    ...
    public static CuboidModelGeometry.Face of(BlockElementFace face){
        return builder()
            ...
            .ambientOcclusion(face.data().ambientOcclusion() ? null : false)
            .property(DefaultModelProperties.FORGE_GEOMETRY_COLOR, face.data().color())
            .property(DefaultModelProperties.FORGE_GEOMETRY_BLOCK_LIGHT, face.data().blockLight())
            .property(DefaultModelProperties.FORGE_GEOMETRY_SKY_LIGHT, face.data().skyLight())
            .property(DefaultModelProperties.FORGE_GEOMETRY_AMBIENT_OCCLUSION, face.data().ambientOcclusion())
            .build();
    }

    private final String material;
    private final BlockElementFace.UVs uv;
    ...
    public CuboidGeometryFaceImpl(String material, BlockElementFace.UVs uv, Quadrant rotation, Direction cullDirection, Integer tintIndex, Boolean shade, Integer lightEmission, Boolean ambientOcclusion, Boolean emissive, Map<Property<?,?>,Function<?,?>> properties){
    ...
    @Override
    public BlockElementFace.UVs uv(){
        return this.uv;
    }
    ...
    private static class Builder implements CuboidModelGeometry.Face.Builder {
        ...
        private BlockElementFace.UVs uv;
        ...
        @Override
        public CuboidModelGeometry.Face.Builder uv(BlockElementFace.UVs uv){
            this.uv = uv;
            return this;
        }
