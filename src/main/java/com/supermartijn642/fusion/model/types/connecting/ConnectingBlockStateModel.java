...
public class ConnectingBlockStateModel implements BlockStateModel {
    ...
    public ConnectingBlockStateModel(List<Part> parts, ModelMaterial.Resolved particleMaterial, int materialFlags){
        this.parts = parts;
    ...
    public record Part(ConnectingModelQuads quads, ModelMaterial.Resolved particleMaterial, int materialFlags) {
    }
}
