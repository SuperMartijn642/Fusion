...
public interface ModelGeometry {
    ...
    /**
     * Converts the given {@link UnbakedModel} to a {@link ModelGeometry} instance.
     */
    static ModelGeometry of(UnbakedModel model){
    ...
    /**
     * Whether this geometry should be at a z-offset as to not intersect with gui elements when rendered as an item.
     */
