...
public class CuboidGeometryFaceImpl implements CuboidModelGeometry.Face {
    ...
    public CuboidGeometryFaceImpl(String material, CuboidFace.UVs uv, Quadrant rotation, Direction cullDirection, Integer tintIndex, Boolean shade, Integer lightEmission, Boolean ambientOcclusion, Boolean emissive, Map<ModelProperty<?,?>,Function<?,?>> properties){
