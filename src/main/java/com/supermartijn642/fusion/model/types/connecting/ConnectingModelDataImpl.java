...
public class ConnectingModelDataImpl extends BaseModelDataImpl implements ConnectingModelData {
    ...
    public ConnectingModelDataImpl(ModelBlock model, List<ResourceLocation> parents, List<ConnectingModelElement> elements, Map<String,Either<ConnectionPredicate,String>> connections){
        ...
        while(true){
            ...
            if(newKey == null){
                for(ModelInstance<?> model : modelStack){
                    ...
                    if(vanillaModel == null)
                        continue;
                    String value = vanillaModel.textures.get(currentKey);
                    if(value != null){
                        newKey = value;
                        break;
                    }
