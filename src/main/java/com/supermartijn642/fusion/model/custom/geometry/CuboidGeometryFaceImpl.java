...
public class CuboidGeometryFaceImpl implements CuboidModelGeometry.Face {
    ...
    public CuboidGeometryFaceImpl(String material, UV uv, Rotation rotation, Direction cullDirection, Integer tintIndex, Boolean shade, Integer lightEmission, Boolean emissive, Map<Property<?,?>,Function<?,?>> properties){
