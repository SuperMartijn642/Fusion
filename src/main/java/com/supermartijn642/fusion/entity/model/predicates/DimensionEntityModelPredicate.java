...
public class DimensionEntityModelPredicate implements EntityModelPredicate {
    ...
    public static EntityModelPredicate create(ResourceKey<Level>... dimensions){
        return new DimensionEntityModelPredicate(Arrays.stream(dimensions).map(ResourceKey::identifier).collect(Collectors.toSet()));
    }

    public static EntityModelPredicate create(Identifier... dimensions){
    ...
    private DimensionEntityModelPredicate(Collection<Identifier> dimensions){
    ...
    public boolean test(Entity entity){
        ...
        return level != null && this.dimensions.contains(level.dimension().identifier());
    }
