...
public class ConnectingBakedModel implements BakedModel {
    ...
    public ConnectingBakedModel(List<ConnectingModelQuad> quads, boolean hasAmbientOcclusion, boolean isGui3d, boolean usesBlockLight, TextureAtlasSprite particleIcon, ItemTransforms transforms, BakedOverrides overrides, RenderType neoforgeRenderType){
        ...
        Set<RenderType> itemRenderTypes = new LinkedHashSet<>();
        ...
        this.itemModel = new ItemBakedModel(this) {
            ...
            protected List<BakedQuad> getQuads(ItemStack stack, @NotNull RandomSource random, @NotNull ModelData data, @Nullable RenderType renderType){
                ...
                if(ConnectingBakedModel.this.shouldCheckOriginalItemRenderTypes && getNonModelRenderType(stack) == renderType){
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction cullDirection, RandomSource random, ModelData modelData, @Nullable RenderType renderType){
        ...
        List<TextureConnections> predicateEvaluations = modelData.get(PREDICATES_EVALUATION_PROPERTY);
