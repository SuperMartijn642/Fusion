...
public class ModelStackImpl implements ModelStack {
    ...
    private ModelStackImpl(ModelStackImpl[] stack, UntypedModelInstance model, Identifier identifier){
    ...
    @Override
    public ModelStack push(UntypedModelInstance instance, @Nullable Identifier identifier){
