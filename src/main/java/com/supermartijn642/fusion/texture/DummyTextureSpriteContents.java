...
public class DummyTextureSpriteContents extends SpriteContents {
    ...
    private DummyTextureSpriteContents(DummyTextureSpriteContents parent, TextureOutputImpl<?> textureOutput){
        super(textureOutput.getIdentifier(), new FrameSize(0, 0), EMPTY_IMAGE, AnimationMetadataSection.EMPTY);
        this.parent = parent;
    ...
    @Override
    protected @Nullable AnimatedTexture createAnimatedTexture(FrameSize frameSize, int i, int j, AnimationMetadataSection animationMetadataSection){
        return null;
    }
    ...
    public class Child extends SpriteContents {
        ...
        public Child(SpriteBuilderImpl spriteBuilder){
            super(spriteBuilder.getIdentifier(), new FrameSize(spriteBuilder.getWidth(), spriteBuilder.getHeight()), EMPTY_IMAGE, AnimationMetadataSection.EMPTY);
