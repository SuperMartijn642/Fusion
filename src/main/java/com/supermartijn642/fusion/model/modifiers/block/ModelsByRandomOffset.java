...
public class ModelsByRandomOffset {
    ...
    private Vector3d defaultBlockOffset;

    public void setContext(BlockPos blockPos, Vector3d defaultBlockOffset){
    ...
    public static class Entry extends CombinedBakedModel {
        ...
        @Override
        protected IModelData getModelData(int modelIndex, IBakedModel model, IBlockDisplayReader level, BlockPos pos, BlockState state, IModelData modelData){
