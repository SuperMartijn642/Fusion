...
public class FusionMixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage){
        ...
        this.isSodiumLoaded = !this.isEmbeddiumLoaded && isClassAvailable("me.jellysquid.mods.sodium.client.SodiumClientMod");
    ...
    public List<String> getMixins(){
        ...
        if(this.isEmbeddiumLoaded){
            ...
            mixins.add("sodium.SpriteContentsInterpolationDataMixinEmbeddium");
        }
