...
public interface SpriteImageSource {
     ...
     */
    static SpriteImageSource vanilla(BufferedImage image, AnimationMetadataSection vanillaMetadata) throws UserErrorException{
     ...
     * @throws UserErrorException when the given image and animation metadata do not pass vanilla's frame size checks
     */
    static SpriteImageSource vanilla(BufferedImage image, AnimationMetadataSection vanillaMetadata, int defaultFrameWidth, int defaultFrameHeight) throws UserErrorException{
