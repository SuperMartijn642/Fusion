...
public class MatchCustomNameItemModelPredicate implements ItemModelPredicate {
    ...
    public static final Serializer<MatchCustomNameItemModelPredicate> SERIALIZER = new Serializer<MatchCustomNameItemModelPredicate>() {
        @Override
    ...
    public boolean test(ItemStack stack){
        return stack.hasCustomHoverName() && this.matcher.test(stack.getHoverName().getString());
    }
