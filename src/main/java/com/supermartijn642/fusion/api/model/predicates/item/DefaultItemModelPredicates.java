...
public final class DefaultItemModelPredicates {
     ...
     */
    public static ItemModelPredicate enchantment(Identifier enchantment){
     ...
     */
    public static ItemModelPredicate enchantment(Identifier enchantment, int level){
     ...
     */
    public static ItemModelPredicate enchantment(Identifier enchantment, int minLevel, int maxLevel){
