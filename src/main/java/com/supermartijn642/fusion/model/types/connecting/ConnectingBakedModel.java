...
public class ConnectingBakedModel extends WrappedBakedModel {
    ...
    public @Nonnull List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random random, @Nonnull IModelData modelData){
        ...
        if(quads == null){
            ...
            boolean isOriginalRenderType = state == null || renderType == null || state.canRenderInLayer(renderType);
    ...
    private static class RenderKey {
        ...
        private RenderKey(int surroundingBlockData, Direction face, BlockRenderLayer renderType){
            this.surroundingBlockData = surroundingBlockData;
            this.face = face;
            this.renderType = renderType;
        }

        void update(int surroundingBlockData, Direction face, BlockRenderLayer renderType){
            this.surroundingBlockData = surroundingBlockData;
            this.face = face;
            this.renderType = renderType;
        }
