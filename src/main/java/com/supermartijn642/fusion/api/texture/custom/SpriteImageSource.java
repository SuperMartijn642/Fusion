...
public interface SpriteImageSource {
     ...
     */
    static SpriteImageSource constant(BufferedImage image){
     ...
     */
    static SpriteImageSource animated(BufferedImage image, int frameWidth, int frameHeight, List<AnimationFrame> frames, boolean interpolateFrames){
     ...
     */
    static SpriteImageSource vanilla(BufferedImage image, AnimationMetadataSection vanillaMetadata) throws TextureErrorException{
     ...
     * @throws TextureErrorException when the given image and animation metadata do not pass vanilla's frame size checks
     */
    static SpriteImageSource vanilla(BufferedImage image, AnimationMetadataSection vanillaMetadata, int defaultFrameWidth, int defaultFrameHeight) throws TextureErrorException{
