...
public class SectionCompilerMixin {
    ...
    private BlockStateModel collectModelsByOffset(BlockStateModel model,
                                                  ...
                                                  @Local BlockState blockState, @Local(ordinal = 2) BlockPos pos, @Local RenderSectionRegion renderRegion, @Local PoseStack poseStack, @Local Function<ChunkSectionLayer,VertexConsumer> buffers, @Local(ordinal = 1) List<BlockModelPart> parts, @Local RandomSource randomSource){
