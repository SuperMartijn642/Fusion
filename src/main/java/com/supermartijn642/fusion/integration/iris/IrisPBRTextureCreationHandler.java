...
public class IrisPBRTextureCreationHandler {
    ...
    static{
        try{
            ...
            Constructor<?> constructor = pbrSpriteContents.getDeclaredConstructor(ResourceLocation.class, FrameSize.class, NativeImage.class, ResourceMetadata.class, PBRType.class);
     ...
     */
    private static AtlasPBRLoader.PBRTextureAtlasSprite instantiatePBRTextureAtlasSprite(ResourceLocation name, FrameSize size, NativeImage image, ResourceMetadata metadata, PBRType pbrType, int atlasWidth, int atlasHeight, int x, int y, TextureAtlasSprite baseSprite){
        try{
    ...
    private static void createPBRSprites(TextureOutputImpl<?> textureOutput, TextureInstance<?> regularTexture, int atlasWidth, int atlasHeight, int mipLevel, PBRType pbrType, Consumer<AtlasPBRLoader.PBRTextureAtlasSprite> spriteConsumer) throws UserErrorException{
        ...
        for(SpriteBuilderImpl spriteBuilder : textureOutput.getSprites()){
            ...
            FusionSpriteContents contents = new FusionSpriteContents(identifier, (SpriteImageSourceImpl)spriteBuilder.getImageSource(), regularSprite.getSprite().contents().metadata());
