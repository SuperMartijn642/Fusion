...
public class ConnectingBakedModel implements BakedModel, CustomRenderTypeBakedModel {
    ...
    public ConnectingBakedModel(List<Part> parts, TextureAtlasSprite particleSprite, boolean ambientOcclusion, BlockModel.GuiLight guiLight, boolean isGui3d, ItemTransforms transforms){
        this.parts = parts;
    ...
    public @NotNull List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction cullDirection, @NotNull Random random, @NotNull IModelData modelData){
        BlockAndTintGetter level = modelData.getData(LEVEL_PROPERTY);
