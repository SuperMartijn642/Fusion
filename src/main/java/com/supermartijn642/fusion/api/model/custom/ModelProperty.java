...
public final class ModelProperty<X, C> {
     ...
     */
    public static final ModelProperty<Integer,Void> FORGE_GEOMETRY_COLOR = create();
    /**
     * @see ForgeFaceData#blockLight()
     */
    public static final ModelProperty<Integer,Void> FORGE_GEOMETRY_BLOCK_LIGHT = create();
    /**
     * @see ForgeFaceData#skyLight()
     */
    public static final ModelProperty<Integer,Void> FORGE_GEOMETRY_SKY_LIGHT = create();
    /**
     * @see ForgeFaceData#ambientOcclusion()
     */
    public static final ModelProperty<Boolean,Void> FORGE_GEOMETRY_AMBIENT_OCCLUSION = create();
