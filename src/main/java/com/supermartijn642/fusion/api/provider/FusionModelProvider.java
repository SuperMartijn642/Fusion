 ...
 * Users may use {@link FusionModelProvider#addModel(Identifier, ModelInstance)} to add models which should be generated.
 * <p>
...
public abstract class FusionModelProvider implements DataProvider {
     ...
     */
    public FusionModelProvider(String modid, FabricPackOutput output){
     ...
     */
    public final <T> void addModel(Identifier location, ModelType<T> modelType, T data){
