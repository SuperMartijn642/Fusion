...
public class CuboidModelType extends UnknownModelType<BlockModel> {
    ...
    @Override
    public BlockStateModel bakeBlockStateModel(BlockStateModelBakingContext context, ModelStack modelStack, BlockModel data){
        // Bake geometry
    ...
    public @Nullable ItemModel bakeItemModel(ItemModelBakingContext context, ModelStack modelStack, BlockModel data){
        ...
        if(geometry != null){
            ...
            return new BlockModelWrapper(
                ...
                quads.toQuadCollection().getAll(),
                new ModelRenderProperties(
                    guiLight.lightLikeBlock(),
                    particleSprite,
                    itemTransforms
                ),
                BlockModelWrapper.detectRenderType(quads.toQuadCollection().getAll())
            );
        }
