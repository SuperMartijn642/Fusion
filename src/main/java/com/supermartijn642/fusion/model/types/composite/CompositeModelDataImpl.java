...
public class CompositeModelDataImpl implements CompositeModelData {
    ...
    public static CompositeModelData.ModelEntry entry(Identifier model, ModelTransform transform, @Nullable ModelPredicate condition){
    ...
    private static class ModelEntryImpl implements CompositeModelData.ModelEntry {
        ...
        private ModelEntryImpl(Either<Identifier,ModelInstance<?>> model, ModelTransform transform, ModelPredicate condition){
            this.model = model;
        ...
        @Override
        public Either<Identifier,ModelInstance<?>> getModel(){
            return this.model;
        }
