...
public class DefaultModelProperties {
     ...
     */
    public static final Property<RenderTypeGroup,Void> NEO_MODEL_RENDER_TYPE = Property.create();
    /**
     * @see ExtraFaceData#color()
     */
    public static final Property<Integer,Void> NEO_GEOMETRY_COLOR = Property.create();
    /**
     * @see ExtraFaceData#lightEmission()
     */
    public static final Property<Integer,Void> NEO_GEOMETRY_LIGHT_EMISSION = Property.create();
    /**
