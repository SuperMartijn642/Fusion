...
public class ItemModelBakingContextImpl extends BlockStateModelBakingContextImpl implements ItemModelBakingContext {
    ...
    public ItemModelBakingContextImpl(Consumer<String> warnings, Identifier identifier, ModelTransform transform, ModelBaker modelBaker, ContextMap neoforgeAdditionalProperties, List<ItemTintSource> tintSources, EntityModelSet entityModelSet){
