...
public interface CuboidModelDataBuilder<T extends CuboidModelDataBuilder<T,S>, S> {
     ...
     */
    static CuboidModelDataBuilder<?,ModelBlock> builder(){
     ...
     */
    T isGui3d(@Nullable Boolean isGui3d);
     ...
     */
    T itemTransform(ItemCameraTransforms.TransformType type, @Nullable ItemTransformVec3f transform);
