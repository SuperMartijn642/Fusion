...
public class TextureCreationHandler {
    ...
    public static Result<SpriteContents> onLoadTexture(Identifier identifier, NativeImage image, Optional<AnimationMetadataSection> animationMetadata, Optional<TextureMetadataSection> textureMetadata, List<MetadataSectionType.WithValue<?>> resourceMetadata){
    ...
    public static void afterLoadSprites(Map<Identifier,TextureAtlasSprite> textures, int atlasWidth, int atlasHeight, Stitcher<SpriteContents> stitcher){
    ...
    private static TextureInstance<?> createTextureInstance(DummyTextureSpriteContents contents, Map<Identifier,TextureAtlasSprite> textures, int atlasWidth, int atlasHeight, Stitcher<SpriteContents> stitcher){
        // Create sub-textures
        ...
        for(DummyTextureSpriteContents.Child child : contents.children()){
            Identifier identifier = child.spriteBuilder().getIdentifier();
            ...
            if(constructor == null){
                newSprite = new TextureAtlasSprite(
                    ...
                    new FusionSpriteContents(identifier, (SpriteImageSourceImpl)spriteBuilder.getImageSource(), contents.additionalMetadata, contents.textureMetadata()),
                    atlasWidth,
                    atlasHeight,
                    currentSprite.getX(),
                    currentSprite.getY(),
                    currentSprite.padding
                ) {};
            }else{
    ...
    private static void removeTextureSprites(DummyTextureSpriteContents contents, Map<Identifier,TextureAtlasSprite> textures){
        for(DummyTextureSpriteContents.Child child : contents.children())
