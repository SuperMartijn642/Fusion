...
public interface CompositeModelData {
    ...
    interface ModelEntry {
         ...
         */
        static ModelEntry of(Identifier model, ModelTransform transform, @Nullable ModelPredicate condition){
         ...
         */
        Either<Identifier,ModelInstance<?>> getModel();
    ...
    interface Builder {
         ...
         */
        default Builder material(String key, ModelMaterial material){
            return this.material(key, Either.right(material));
        }

        /**
         * Sets the material for the given key.
         * @param key              materials key to set
         ...
         */
        default Builder material(String key, Identifier texture, boolean forceTranslucent){
            return this.material(key, ModelMaterial.of(texture, forceTranslucent));
        }

        /**
         * Sets the material for the given key.
         */
        default Builder material(String key, Identifier texture){
         ...
         */
        Builder guiLight(@Nullable UnbakedModel.GuiLight guiLight);
         ...
         */
        Builder itemTransform(ItemDisplayContext type, @Nullable ItemTransform transform);

        /**
         * Sets the transformations used to render the model as an item.
         */
        Builder itemTransforms(ItemTransforms itemTransforms);
