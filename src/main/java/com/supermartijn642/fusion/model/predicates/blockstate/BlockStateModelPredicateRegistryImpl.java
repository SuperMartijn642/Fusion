...
public class BlockStateModelPredicateRegistryImpl {
    ...
    private static final Map<Identifier,Serializer<? extends BlockStateModelPredicate>> IDENTIFIER_TO_SERIALIZER = new HashMap<>();
    private static final Map<Serializer<? extends BlockStateModelPredicate>,Identifier> SERIALIZER_TO_IDENTIFIER = new HashMap<>();
    private static boolean finalized = false;

    public static synchronized void registerPredicate(Identifier identifier, Serializer<? extends BlockStateModelPredicate> serializer){
        if(finalized)
    ...
    public static synchronized boolean containsIdentifier(Identifier identifier){
