...
public class ItemModelBakingContextImpl extends BlockStateModelBakingContextImpl implements ItemModelBakingContext {
    ...
    public ItemModelBakingContextImpl(Consumer<String> warnings, Identifier identifier, ModelTransform transform, ModelBaker modelBaker, Function<Material,Material.Baked> materialBaker, ContextMap neoforgeAdditionalProperties, List<ItemTintSource> tintSources, EntityModelSet entityModelSet){
        super(warnings, identifier, transform, modelBaker, materialBaker, neoforgeAdditionalProperties);
