...
public class EnchantmentItemModelPredicate implements ItemModelPredicate {
    ...
    public static ItemModelPredicate create(Identifier enchantment){
        return create(enchantment, 1, 255);
    }

    public static ItemModelPredicate create(Identifier enchantment, int level){
        return create(enchantment, level, level);
    }

    public static ItemModelPredicate create(Identifier enchantment, int minLevel, int maxLevel){
        if(enchantment == null)
    ...
    private EnchantmentItemModelPredicate(Identifier enchantment, int minLevel, int maxLevel){
