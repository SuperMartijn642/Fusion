...
public class CuboidGeometryFaceImpl implements CuboidModelGeometry.Face {
    ...
    public static CuboidModelGeometry.Face of(BlockElementFace face){
        return builder()
            ...
            .property(DefaultModelProperties.FORGE_GEOMETRY_COLOR, face.getFaceData().color())
            .property(DefaultModelProperties.FORGE_GEOMETRY_BLOCK_LIGHT, face.getFaceData().blockLight())
            .property(DefaultModelProperties.FORGE_GEOMETRY_SKY_LIGHT, face.getFaceData().skyLight())
            .property(DefaultModelProperties.FORGE_GEOMETRY_AMBIENT_OCCLUSION, face.getFaceData().ambientOcclusion())
            .build();
    }
