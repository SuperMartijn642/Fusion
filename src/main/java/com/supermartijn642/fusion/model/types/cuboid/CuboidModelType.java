...
public class CuboidModelType extends SimpleModelType<BlockModel> {
    ...
    public @Nullable BakedModel bakeModel(ModelBakingContext context, ModelStack modelStack, BlockModel data){
        // Handle NeoForge custom geometry
        IUnbakedGeometry<?> customGeometry = data.customData.getCustomGeometry();
        if(customGeometry != null){
            ...
            ModelBaker modelBaker = new ModelBaker() {
                ...
                @Override
                public @Nullable UnbakedModel getTopLevelModel(ModelResourceLocation identifier){
                    return null;
                }
                ...
                @Override
                public BakedModel bakeUncached(UnbakedModel model, ModelState modelState, Function<Material,TextureAtlasSprite> spriteGetter){
            ...
            List<ItemOverride> itemOverrides = this.getItemOverrides(data);
