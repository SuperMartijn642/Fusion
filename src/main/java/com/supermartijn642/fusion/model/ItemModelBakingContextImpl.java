...
public class ItemModelBakingContextImpl extends BlockStateModelBakingContextImpl implements ItemModelBakingContext {
    ...
    public ItemModelBakingContextImpl(Consumer<String> warnings, ResourceLocation identifier, ModelTransform transform, ModelBaker modelBaker, ContextMap neoforgeAdditionalProperties, List<ItemTintSource> tintSources, EntityModelSet entityModelSet){
        super(warnings, identifier, transform, modelBaker, neoforgeAdditionalProperties);
