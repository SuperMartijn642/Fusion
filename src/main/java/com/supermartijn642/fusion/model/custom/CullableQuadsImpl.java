...
public class CullableQuadsImpl implements CullableQuads {
    ...
    private QuadCollection quadCollection;
    ...
    @Override
    public QuadCollection toQuadCollection(){
        if(this.quadCollection == null){
            QuadCollection.Builder builder = new QuadCollection.Builder();
            this.unculled.forEach(q -> builder.addUnculledFace(q.toBakedQuad()));
            this.up.forEach(q -> builder.addCulledFace(Direction.UP, q.toBakedQuad()));
            this.down.forEach(q -> builder.addCulledFace(Direction.DOWN, q.toBakedQuad()));
            this.north.forEach(q -> builder.addCulledFace(Direction.NORTH, q.toBakedQuad()));
            this.east.forEach(q -> builder.addCulledFace(Direction.EAST, q.toBakedQuad()));
            this.south.forEach(q -> builder.addCulledFace(Direction.SOUTH, q.toBakedQuad()));
            this.west.forEach(q -> builder.addCulledFace(Direction.WEST, q.toBakedQuad()));
            this.quadCollection = builder.build();
        }
        return this.quadCollection;
    }
