...
public class BlockStateModelBakingContextImpl implements BlockStateModelBakingContext {
    ...
    public BlockStateModelBakingContextImpl(Consumer<String> warnings, Identifier identifier, ModelTransform transform, ModelBaker modelBaker, Function<Material,Material.Baked> materialBaker){
