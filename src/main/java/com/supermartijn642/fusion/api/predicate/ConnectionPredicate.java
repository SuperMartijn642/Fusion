...
public interface ConnectionPredicate {
     ...
     * @return {@code true} if the texture should connect in the given direction
     */
    default boolean shouldConnect(IBlockReader level, BlockPos pos, Direction side, @Nullable BlockState ownState, BlockState otherState, BlockState blockInFront, ConnectionDirection direction){
