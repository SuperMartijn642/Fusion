...
public class CompositeBakedModel implements IBakedModel, CustomRenderTypeBakedModel {
    ...
    private RenderData getRenderData(@Nullable ItemStack stack, @Nullable IEnviromentBlockReader level, @Nullable BlockPos pos, @Nullable BlockState state, @Nullable IModelData modelData){
    ...
    public static class ConditionalList {
        ...
        @Nullable
        IBakedModel get(IEnviromentBlockReader level, BlockPos pos, BlockState state){
