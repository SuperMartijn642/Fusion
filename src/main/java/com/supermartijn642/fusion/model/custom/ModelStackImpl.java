...
public class ModelStackImpl implements ModelStack {
    ...
    @Override
    public @Nullable ItemTransform findItemTransform(ItemTransforms.TransformType type){
        for(ModelStackImpl entry : this.stack){
    ...
    @Override
    public @Nullable ItemTransform findItemTransformIncludingParents(ItemTransforms.TransformType type, ModelResolver modelResolver){
        return this.walkStackAndParents(
            modelResolver,
            (modelInstance, stack) -> {
