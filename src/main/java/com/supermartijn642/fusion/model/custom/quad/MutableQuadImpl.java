...
public class MutableQuadImpl implements MutableQuad {
    ...
    public MutableQuad copyBakedQuad(BakedQuad quad){
        ...
        for(int i = 0; i < 4; i++){
            ...
            this.vertices[offset] = BakedQuadHelper.getPosX(quad.vertices(), i);
            this.vertices[offset + 1] = BakedQuadHelper.getPosY(quad.vertices(), i);
            this.vertices[offset + 2] = BakedQuadHelper.getPosZ(quad.vertices(), i);
            offset = i * VERTEX_SIZE + VERTEX_UV;
            this.vertices[offset] = BakedQuadHelper.getU(quad.vertices(), i);
            this.vertices[offset + 1] = BakedQuadHelper.getV(quad.vertices(), i);
        }
