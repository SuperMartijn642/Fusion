...
public class OrModelPredicate implements ModelPredicate {
    ...
    public static final Serializer<OrModelPredicate> SERIALIZER = new Serializer<>() {
        @Override
    ...
    public final boolean equals(Object o){
        ...
        if(!(o instanceof OrModelPredicate that)) return false;
