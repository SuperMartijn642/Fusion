...
public interface RandomOffsetFunction {
    ...
    RandomOffsetFunction NONE = (original, pos, output) -> output.zero();
    RandomOffsetFunction MATCH_BLOCK = (original, pos, output) -> output.set(original.x, original.y, original.z);
