...
public class ConnectingBakedModel implements BlockStateModel {
    ...
    public ConnectingBakedModel(List<ConnectingModelQuad> quads, boolean hasAmbientOcclusion, TextureAtlasSprite particleIcon, ChunkSectionLayer forgeRenderType){
    ...
    private List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction cullDirection, RandomSource random, ModelData modelData, @Nullable ChunkSectionLayer renderType){
        ...
        SurroundingBlockCache blockCache = modelData.get(BLOCK_CACHE_PROPERTY);
