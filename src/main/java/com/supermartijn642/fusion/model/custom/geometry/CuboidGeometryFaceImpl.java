...
public class CuboidGeometryFaceImpl implements CuboidModelGeometry.Face {
    ...
    public static CuboidModelGeometry.Face of(BlockElementFace face){
        return builder()
            ...
            .property(DefaultModelProperties.NEO_GEOMETRY_BLOCK_LIGHT, face.faceData().blockLight())
            .property(DefaultModelProperties.NEO_GEOMETRY_SKY_LIGHT, face.faceData().skyLight())
