...
public class BlockModelModifierBakedModel extends WrappedBakedModel {
    ...
    public void collectByOffset(ModelsByRandomOffset output, @Nullable BlockAndTintGetter level, @Nullable BlockPos pos, @Nullable BlockState state, @Nullable IModelData modelData){
