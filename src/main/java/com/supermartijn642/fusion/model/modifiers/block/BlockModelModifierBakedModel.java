...
public class BlockModelModifierBakedModel implements BakedModel {
    ...
    @Override
    public void applyTransform(ItemDisplayContext type, PoseStack poseStack, boolean applyLeftHandTransform){
        this.original.applyTransform(type, poseStack, applyLeftHandTransform);
    }
