...
public final class DefaultConnectionPredicates {
     ...
     */
    public static ConnectionPredicate matchState(List<Block> blocks, Pair<IProperty<?>,?>... properties){
     ...
     * @param properties property value pairs that should be matched
     */
    public static ConnectionPredicate matchStateInFront(List<Block> blocks, Pair<IProperty<?>,?>... properties){
