...
public class ModelBakingContextImpl implements ModelBakingContext {
    ...
    public ModelBakingContextImpl(Consumer<String> warnings, ResourceLocation identifier, ModelTransform transform, Function<RenderMaterial,TextureAtlasSprite> textureGetter, Map<ResourceLocation,ModelInstance<?>> dependencies, ModelBakery modelBaker){
