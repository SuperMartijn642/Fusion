...
public class MutableQuad {
    ...
    static{
        ...
        LIGHTMAP_OFFSET = format.getOffset(format.getElements().indexOf(DefaultVertexFormat.ELEMENT_UV2)) / 4;
        UV_OFFSET = format.getOffset(format.getElements().indexOf(DefaultVertexFormat.ELEMENT_UV)) / 4;
        POSITION_OFFSET = format.getOffset(format.getElements().indexOf(DefaultVertexFormat.ELEMENT_POSITION)) / 4;
    }
