...
public class ItemModelModifierBakedModel implements IBakedModel {
    ...
    @Override
    public List<com.mojang.datafixers.util.Pair<IBakedModel,RenderType>> getLayerModels(ItemStack stack, boolean fabulous){
        return this.defaultModel.getLayerModels(stack, fabulous);
    }

    @Override
    public @Nonnull IModelData getModelData(@Nonnull IBlockDisplayReader level, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull IModelData data){
