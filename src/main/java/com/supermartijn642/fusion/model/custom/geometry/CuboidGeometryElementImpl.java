...
public class CuboidGeometryElementImpl implements CuboidModelGeometry.Element {
    ...
    public static CuboidModelGeometry.Element of(CuboidModelElement element){
        return builder()
            ...
            .property(ModelProperty.NEO_GEOMETRY_COLOR, element.faceData().color())
            .property(ModelProperty.NEO_GEOMETRY_LIGHT_EMISSION, element.faceData().lightEmission())
            .property(ModelProperty.NEO_GEOMETRY_AMBIENT_OCCLUSION, element.faceData().ambientOcclusion())
            .build();
    }
    ...
    private CuboidGeometryElementImpl(Vector3fc from, Vector3fc to, CuboidRotation rotation, Map<Direction,CuboidModelGeometry.Face> faces, Boolean shade, Integer lightEmission, Boolean ambientOcclusion, Boolean emissive, Map<ModelProperty<?,?>,Function<?,?>> properties){
        this.from = from;
        this.to = to;
    ...
    @Override
    public CuboidRotation rotation(){
    ...
    private static class Builder implements CuboidModelGeometry.Element.Builder {
        ...
        @Override
        public Builder rotation(CuboidRotation rotation){
            this.rotation = rotation;
            return this;
        }
