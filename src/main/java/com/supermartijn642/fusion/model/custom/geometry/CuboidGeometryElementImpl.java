...
public class CuboidGeometryElementImpl implements CuboidModelGeometry.Element {
    ...
    private CuboidGeometryElementImpl(Vector3f from, Vector3f to, BlockElementRotation rotation, Map<Direction,CuboidModelGeometry.Face> faces, Boolean shade, Integer lightEmission, Boolean ambientOcclusion, Boolean emissive, Map<Property<?,?>,Function<?,?>> properties){
        this.from = from;
        this.to = to;
