...
public class CuboidModelGeometryImpl implements CuboidModelGeometry {
    ...
    public static QuadAccess bakeFace(Face face, Element element, EnumFacing side, ModelTransform transformation, MaterialResolver materialResolver){
    ...
    public static void bakeFace(QuadConsumer consumer, Face face, Element element, EnumFacing side, ModelTransform transformation, MaterialResolver materialResolver){
