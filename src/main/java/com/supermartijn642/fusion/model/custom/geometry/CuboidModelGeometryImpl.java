...
public class CuboidModelGeometryImpl implements CuboidModelGeometry {
    ...
    private static BlockElementFace.UVs calculateFaceUV(Element element, Direction side){
        ...
        BlockElementFace.UVs uv = FaceBakery.defaultFaceUV(from, to, side);
        ...
        if(sameBlockSpace){
            ...
            uv = new BlockElementFace.UVs(uv.minU() - blockSpaceU, uv.minV() - blockSpaceV, uv.maxU() - blockSpaceU, uv.maxV() - blockSpaceV);
        }
        return uv;
    }
