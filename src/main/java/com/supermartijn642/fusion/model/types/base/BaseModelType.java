...
public abstract class BaseModelType<T extends BaseModelData, BUILDER extends BaseModelData.Builder<BUILDER,T>> extends SimpleModelType<T> {
    ...
    protected JsonObject serializeRotation(BlockElementRotation rotation){
        ...
        Vector3f origin = rotation.origin.copy();
        origin.mul(16);
        rotationJson.add("origin", this.serializeVector3f(origin));
    ...
    protected ItemTransform deserializeItemTransform(JsonObject json, String name, ItemTransforms.TransformType type){
        ...
        Vector3f rotation = object.has("rotation") ?
            ...
            ItemTransform.Deserializer.DEFAULT_ROTATION.copy();
        Vector3f translation = object.has("translation") ?
            ...
            ItemTransform.Deserializer.DEFAULT_TRANSLATION.copy();
        ...
        Vector3f scale = object.has("scale") ?
            ...
            ItemTransform.Deserializer.DEFAULT_SCALE.copy();
