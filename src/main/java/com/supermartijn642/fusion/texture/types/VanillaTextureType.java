...
public class VanillaTextureType implements TextureType<Void,Void> {
    ...
    @Override
    public @Nullable BlockStateQuadProcessor<?> initializeBlockStateModelQuad(MutableQuad quad, SpriteInstance sprite, Void data, PropertyStore properties){
        return null;
    }

    @Override
    public @Nullable ItemQuadProcessor<?> initializeItemModelQuad(MutableQuad quad, SpriteInstance sprite, Void data, PropertyStore properties){
        return null;
    }
