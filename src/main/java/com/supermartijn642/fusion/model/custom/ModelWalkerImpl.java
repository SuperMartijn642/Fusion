...
public class ModelWalkerImpl {
    ...
    public static <T> Optional<T> walkModelTree(Function<Identifier,ModelInstance<?>> modelResolver, UntypedModelInstance modelInstance, ModelWalker<T> walker){
    ...
    private static <T> ModelWalker.Result<T> walk(ModelStackImpl stack, Function<Identifier,UntypedModelInstance> modelResolver, Either<Identifier,UntypedModelInstance> entry, ModelWalker<T> walker){
    ...
    private static class ModelStackImpl implements ModelWalker.ModelStack {
        ...
        private final List<Pair<Identifier,UntypedModelInstance>> models = new ArrayList<>(); // Model trees aren't expected to get very tall, hence an array list should be fine

        void push(Identifier identifier, UntypedModelInstance modelInstance){
        ...
        public @NotNull Iterator<UntypedModelInstance> iterator(){
            Iterator<Pair<Identifier,UntypedModelInstance>> iterator = this.models.iterator();
            return new Iterator<>() {
                @Override
