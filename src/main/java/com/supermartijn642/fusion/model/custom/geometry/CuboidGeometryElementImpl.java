...
public class CuboidGeometryElementImpl implements CuboidModelGeometry.Element {
    ...
    private final Map<EnumFacing,CuboidModelGeometry.Face> faces;
    private final Boolean shade;
    private final Integer lightEmission;
    private final Boolean emissive;
    private final Map<ModelProperty<?,?>,Function<?,?>> properties;

    private CuboidGeometryElementImpl(Vector3f from, Vector3f to, BlockPartRotation rotation, Map<EnumFacing,CuboidModelGeometry.Face> faces, Boolean shade, Integer lightEmission, Boolean emissive, Map<ModelProperty<?,?>,Function<?,?>> properties){
        this.from = from;
        this.to = to;
    ...
    @Override
    public BlockPartRotation rotation(){
        return this.rotation;
    }

    @Override
    public CuboidModelGeometry.Face face(EnumFacing side){
    ...
    private static class Builder implements CuboidModelGeometry.Element.Builder {
        ...
        private final Map<EnumFacing,CuboidModelGeometry.Face> faces = new EnumMap<>(EnumFacing.class);
        ...
        @Override
        public Builder rotation(BlockPartRotation rotation){
            this.rotation = rotation;
            return this;
        }

        @Override
        public Builder face(EnumFacing side, CuboidModelGeometry.Face face){
            if(face == null)
