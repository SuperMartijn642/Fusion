...
public interface CompositeModelData {
    ...
    interface Builder {
        ...
        default Builder material(String key, ResourceLocation texture){
            return this.material(key, Either.right(ModelMaterial.blockAtlas(texture)));
        }

        /**
         * Sets the lighting to use when the model is rendered in a gui.
         */
        Builder guiLight(@Nullable BlockModel.GuiLight guiLight);
         ...
         */
        Builder itemTransform(ItemTransforms.TransformType type, @Nullable ItemTransform transform);
