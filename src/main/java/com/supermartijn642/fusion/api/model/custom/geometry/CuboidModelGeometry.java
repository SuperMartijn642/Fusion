...
public interface CuboidModelGeometry extends ModelGeometry {
    ...
    /**
     * Converts the given {@link ModelBlock} to a {@link CuboidModelGeometry} instance.
     */
    static CuboidModelGeometry of(ModelBlock model){
     ...
     * @param materialResolver resolver for material keys
     */
    static QuadAccess bakeFace(Face face, Element element, EnumFacing side, ModelTransform transformation, MaterialKeyResolver materialResolver){
     ...
     * @param materialResolver resolver for material keys
     */
    static void bakeFace(QuadConsumer consumer, Face face, Element element, EnumFacing side, ModelTransform transformation, MaterialKeyResolver materialResolver){
    ...
    interface Element extends PropertyGetter {
        ...
        interface Builder {
             ...
             */
            Builder face(@Nullable EnumFacing side, Face face);
    ...
    interface Face extends PropertyGetter {
        ...
        interface Builder {
             ...
             */
            Builder cullDirection(@Nullable EnumFacing direction);
