...
public class ConnectingBakedModel implements IBakedModel, CustomRenderTypeBakedModel {
    ...
    public ConnectingBakedModel(List<Part> parts, TextureAtlasSprite particleSprite, boolean ambientOcclusion, boolean isGui3d, ItemCameraTransforms transforms){
        this.parts = parts;
    ...
    static class QuadPredicatesKey {
        ...
        QuadPredicatesKey(EnumFacing direction, TextureOrientation orientation, ConnectionPredicate predicate){
