...
public enum TextureOrientation {
    ...
    static{
        DEFAULT_TEXTURE_ROTATIONS_UP[Direction.DOWN.ordinal()] = new int[]{0, 0, 1};
        DEFAULT_TEXTURE_ROTATIONS_RIGHT[Direction.DOWN.ordinal()] = new int[]{1, 0, 0};
        DEFAULT_TEXTURE_ROTATIONS_UP[Direction.UP.ordinal()] = new int[]{0, 0, -1};
        DEFAULT_TEXTURE_ROTATIONS_RIGHT[Direction.UP.ordinal()] = new int[]{1, 0, 0};
        DEFAULT_TEXTURE_ROTATIONS_UP[Direction.NORTH.ordinal()] = new int[]{0, 1, 0};
        DEFAULT_TEXTURE_ROTATIONS_RIGHT[Direction.NORTH.ordinal()] = new int[]{-1, 0, 0};
        DEFAULT_TEXTURE_ROTATIONS_UP[Direction.SOUTH.ordinal()] = new int[]{0, 1, 0};
        DEFAULT_TEXTURE_ROTATIONS_RIGHT[Direction.SOUTH.ordinal()] = new int[]{1, 0, 0};
        DEFAULT_TEXTURE_ROTATIONS_UP[Direction.WEST.ordinal()] = new int[]{0, 1, 0};
        DEFAULT_TEXTURE_ROTATIONS_RIGHT[Direction.WEST.ordinal()] = new int[]{0, 0, 1};
        DEFAULT_TEXTURE_ROTATIONS_UP[Direction.EAST.ordinal()] = new int[]{0, 1, 0};
        DEFAULT_TEXTURE_ROTATIONS_RIGHT[Direction.EAST.ordinal()] = new int[]{0, 0, -1};
    }
    ...
    public int[] transformWorldUpVector(Direction face){
        return this.transformWorldVector(DEFAULT_TEXTURE_ROTATIONS_UP[face.ordinal()], face);
    }

    public int[] transformWorldRightVector(Direction face){
