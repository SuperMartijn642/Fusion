...
public class ItemModelModifierReloadListener {
    ...
    public List<ModelResourceLocation> gatherModelDependencies(){
        ...
        return models.stream()
            .map(ItemModelModifierReloadListener::variantModelLocation)
    ...
    public void applyModelModifiers(ModelBakery modelBakery){
        ...
        Function<ResourceLocation,IBakedModel> modelResolver = i -> bakedModels.getObject(variantModelLocation(i));
    ...
    private static List<ItemModelModifierBakedModel.ConditionalModel> createConditionModels(List<ModelEntry> modelEntries, Function<ResourceLocation,IBakedModel> modelResolver){
    ...
    private static ModelResourceLocation variantModelLocation(ResourceLocation modelLocation){
        return new ModelResourceLocation(modelLocation, "fusion_item_model_modifier");
    }
    ...
    private void parseResource(JsonObject json, ResourceLocation location){
        ...
        if(json.has("default_model")){
            ...
            defaultModel = ImmutableList.of(ModelEntry.simple(new ResourceLocation(json.get("default_model").getAsString())));
        }
    ...
    private static List<ModelEntry> parseModelEntry(JsonElement element){
        ...
        return ImmutableList.of(new ModelEntry(model, conditions));
    }
    ...
    private static final class ModelEntry {
        ...
        private ModelEntry(ResourceLocation model, @Nullable ItemModelPredicate conditions){
            this.model = model;
