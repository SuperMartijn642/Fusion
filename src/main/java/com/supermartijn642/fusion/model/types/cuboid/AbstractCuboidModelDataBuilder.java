...
public abstract class AbstractCuboidModelDataBuilder<T extends AbstractCuboidModelDataBuilder<T,S>, S> implements CuboidModelDataBuilder<T,S> {
    ...
    @Override
    public T isGui3d(@Nullable Boolean isGui3d){
    ...
    @Override
    public T itemTransform(ItemCameraTransforms.TransformType type, ItemTransformVec3f transform){
        if(transform == null)
    ...
    @Override
    public T itemTransforms(ItemCameraTransforms itemTransforms){
